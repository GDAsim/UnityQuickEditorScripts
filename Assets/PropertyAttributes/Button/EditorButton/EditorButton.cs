...
public class EditorButton : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            editorButtonStates = new EditorButtonState[membersWithButtonAttribute.Length];
            for (int i = 0; i < membersWithButtonAttribute.Length; i++)
            {
                var method = (MethodInfo)membersWithButtonAttribute[i];
        ...
        for (int i = 0; i < membersWithButtonAttribute.Length; i++)
        {
            ...
            DrawButtonforMethod(targets, method, GetEditorButtonState(method, i));
        }
    }
